...
## Environments
- Preview: https://main--gabrielwalt-richemont--aemysites.aem.page/
- Live: https://main--gabrielwalt-richemont--aemysites.aem.live/
- Block Library: https://main--gabrielwalt-richemont--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `gabrielwalt-richemont` directory in your favorite IDE and start coding :)
